# Durable Workflows Test Materials

**Status:** Prepared; no session has been completed through this directory

## Reader-value packet

The [Durable Workflows Reader-Value Pilot
...
The repository also contains blank result structures and completed constructed
examples under [`../examples/`](../examples/README.md). Those materials may
support a separately declared small-group exercise, but they are not part of
the blinded reader-value participant packet and establish no practitioner
result by themselves.

Do not silently mix methods. Freeze the exact supplied files, name the protocol
used, retain interventions and negative results, and keep every unrun state
truthful.
